...
const jsURL = 'https://raw.githubusercontent.com/sawankumar/GoIndex-Theme-Nexmoe/master/index.js';
...
<head>
    ...
    <title>GoIndex Code Generation</title>
    ...
    <div class="mdui-row">
        <div class="mdui-col-sm-2">
            <a class="mdui-btn mdui-color-theme-accent mdui-ripple"
               ...
               target="_blank">1.Get the authentication code</a>
        </div>
    </div>
    <br><br><br><br><br>
    <div class="mdui-row">
